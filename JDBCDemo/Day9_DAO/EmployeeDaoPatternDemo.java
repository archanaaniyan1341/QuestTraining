...
public class EmployeeDaoPatternDemo
{
  ...
  public static void main( String[] args )
  {
    ...
    System.out.println("Get one Employee based in employee Id =1");
    ...
    System.out.println("update the employee whose employee Id =1");
    ...
    System.out.println("Delete the employee whose employee Id =2");
